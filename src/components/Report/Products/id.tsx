  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <Card className="mt-8">
        ...
        <CardContent>
          <RadioGroup value={String(selectReport)} onValueChange={(value) => setSelectReport(Number(value))}>
            {REPORTS.map((report) => (
              <div key={report.id} className="flex items-start gap-3 py-3 border-b last:border-none">
                <RadioGroupItem value={String(report.id)} id={`report-${report.id}`} className="mt-1" />
                <div className="flex-1">
