    ...
    <div className="container mx-auto py-8 px-4 max-w-3xl">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Platform fee structure and details</p>
        </div>
      </div>
          ...
          {loading ? (
            ...
            <div
              className="prose prose-sm max-w-none
                ...
                prose-blockquote:border-l-sky-400 prose-blockquote:text-muted-foreground
